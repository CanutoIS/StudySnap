...
export default function Post({ post, handleTogglePostModal }) {
    ...
    return <>
        <article className="bg-white border h-[450px] w-full md:min-w-[350px] md:w-[350px] text-black rounded-md p-4 flex flex-col items-center overflow-hidden shadow-md shadow-slate-400 cursor-pointer" id={id.toString()} onScroll={handlePostScroll} onClick={handleOpenPostModal}>
            <section className="flex justify-between w-full p-2 overflow-hidden h-16 md:h-20">
                <div className="flex items-center">
                    ...
                    <p className="px-1 md:text-lg ml-1 notranslate">{author.name}</p>
                </div>
            </section>
