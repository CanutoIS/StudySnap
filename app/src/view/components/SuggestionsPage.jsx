...
export default function SuggestionsPage({ user, handleLastPostsUpdate, lastPostsUpdate, page, handleOpenEditPost, handleOpenDeletePost, handleOpenProfile }) {
    ...
    return <section className="flex flex-col gap-4 px-24 absolute top-28 left-0 overflow-scroll pb-8 w-full items-center md:left-64 md:pr-96">
        ...
        <div className="px-10">
            {suggestions && suggestions.map(suggestion => (!suggestion.hidden || suggestion.author.id === user.id) && <Suggestion
                ...
                handleShowPost={handleShowPostModal}
        ...
        {post && <PostModalWindow
            page={'mySuggestions'}
            handleTogglePostModal={handleHidePost}
            handleLastPostsUpdate={handleLastPostsUpdate}
