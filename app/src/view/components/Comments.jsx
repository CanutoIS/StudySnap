    ...
    return <>
        <section className="flex flex-col items-center w-full h-full py-4 px-1 pt-0">
            <div className="flex flex-col justify-around items-center h-full w-full mb-4">
                <h2 className="mt-2 mb-4 font-bold text-xl md:text-2xl">Comments</h2>
                <div className="flex flex-col overflow-scroll h-full gap-2 w-full px-2 md:px-14">
                ...
                <Button className="mt-2 md:text-lg" onClick={toggleAddComment}>Add comment</Button>
            </div>
            ...
            {addComment &&
                <ModalContainer className='absolute top-0 bg-black bg-opacity-20' onClick={(event) => {
                    ...
                    <Form className='bg-white h-96 p-4 w-5/6 md:w-1/3 md:text-lg' onSubmit={handleCreateComment}>
                        <h2 className="text-lg md:text-2xl">Add comment</h2>
                        <textarea className="border-2 border-gray-200 rounded-md p-2 h-60 w-11/12 md:p-4" cols="30" rows="10" name="commentText" autoFocus></textarea>
