 ...
 * @param {string} conversationId The post id
 * 
...
module.exports = function generateSummaryFromChatbot(userId, conversationId) {
    ...
    return (async () => {
        ...
        const summaryMessage = {
            role: 'user',
            content: 'Generate a long text summarizing describing the discussed topics and in the language in which the previous conversation has been made, whithout saying we have had a previous conversation.'
        }
