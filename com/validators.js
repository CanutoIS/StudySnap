...
function validateUsername(username) {
  ...
  if (/\s/.test(username)) throw new ContentError('The username contains spaces.')
  if (/[A-Z]/.test(username)) throw new ContentError('The username contains uppercase letters.')
}
...
function validateSuggestionContent(content) {
  ...
  if(content.length > 800) throw new ContentError('The suggestion content is too long.')
}
